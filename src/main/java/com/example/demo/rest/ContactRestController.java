...
public class ContactRestController {
    ...
    //post man request http://localhost:8003/api/contact/getMessagesByStatus?status=Open
    ...
    public ResponseEntity<Response> saveMsg(@RequestHeader("invocationFrom") String invocationFrom, @Valid @RequestBody Contact contact) {
        ...
        //http://localhost:8003/api/contact/saveMsg
    }
    ...
    public ResponseEntity<Response> deleteMsg(RequestEntity<Contact> requestEntity){
        ...
        //http://localhost:8003/api/contact/deleteMsg
    }
    ...
    public ResponseEntity<Response> closeMsg(@RequestBody Contact contactReq){
        ...
        return ResponseEntity.status(HttpStatus.OK).body(response);
        //http://localhost:8003/api/contact/closeMsg
    }
}
